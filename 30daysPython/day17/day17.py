...
# ==================== PATIENT ============================ #
    ...
    def book_appointment(self):
        ...
        appointemnts = Appointment(patient, doctor, date)

        self.appointemnts.append(appointment)
    ...
    def view_appointments (self):
        ...
        for appointment in self.appointments:
            ...
            print("Specialization : ", self.appointemnt.doctor.specialization)
